...
const SocialIcons = () => {
  return (
    <div className="parent w-100 h-100 d-flex justify-content-center align-items-center">
      <div className="child d-flex justify-content-center align-items-center child-1">
      ...
      <div className="child d-flex justify-content-center align-items-center child-2 mx-2">
      ...
      <div className="child d-flex justify-content-center align-items-center child-3">
